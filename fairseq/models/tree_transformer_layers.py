...
from fairseq.modules import (
    ...
    SinusoidalPositionalEmbedding, DPTreeMultiheadAttention
)
...
class DPTreeTransformerEncoderLayer(nn.Module):
    ...
    def forward(self, x, indices, encoder_padding_mask):
        """
        ...
        # TODO--here
        x, _ = self.self_attn(query=x, key=x, value=x, indices=indices, key_padding_mask=encoder_padding_mask)
...
class DPTreeTransformerEncoder(FairseqEncoder):
    ...
    def forward(self, src_tokens, src_indices, src_lengths):
        """
        Args:
    ...
    def forward(self, prev_output_tokens, encoder_out=None, incremental_state=None):
        ...
        for layer in self.layers:
            x, attn = layer(
                ...
                encoder_out['encoder_indices'] if encoder_out is not None else None,
                incremental_state,
                # x, encoder_out, encoder_padding_mask, encoder_indices, incremental_state,
